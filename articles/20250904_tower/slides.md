---
theme: seriph
title: What is the Tower from Rivulet?
seoMeta:
  ogImage: auto
---
...
- **Advanced Data Structures**: Built-in Lists, Maps, Sets, Time Series, and Bloom Filters with atomic operations
...
Tower provides comprehensive support for arbitrary-precision integers using Go's `math/big.Int`:
...
Tower implements high-precision fixed-point decimal arithmetic using `math/big.Int` for the coefficient:
...
Built with love by the Rivulet team
